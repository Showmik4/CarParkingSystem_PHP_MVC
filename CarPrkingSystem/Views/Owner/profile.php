...
<div class="row">
  <div class="col-xs-12 col-sm-9">
    <form class="form-horizontal" method="post" action="../../Controllers/OwnerController.php"  enctype="multipart/form-data" >
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label">Car Space</label>
            <div class="col-sm-10">
              <input type="text" name="space"value="<?php echo $info["space"]?>" class="form-control">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="password" name="cpass" value="<?php echo $info["password"]?>"class="form-control" readonly>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
              <button type="submit" name="Updateowner" class="btn btn-primary">Submit</button>
