            ...
            <th>------------------</th>
              ...
              echo "<td>".$infos["phone"]."</td>";
                ...
                echo "<td>".$infos["email"]."</td>";
                        echo "<td>".$infos["space"]."</td>";
                          echo "<td>".$infos["status"]."</td>";
                      echo "<td>".$infos["password"]."</td>";

            echo '<td><button class="btn"><a href="../../Controllers/DeleteoController.php?id='.$infos["sl"].'" i class="fa fa-trash">  delete</a></td>';
                    echo "</tr>";
                  }
                ?>
